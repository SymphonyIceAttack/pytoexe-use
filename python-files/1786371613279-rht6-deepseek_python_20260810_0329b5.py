...
# ---------- ФАЛЬШИВЫЕ СИГНАТУРЫ ТРОЯНОВ (ДЛЯ ОБМАНА АНТИВИРУСОВ) ----------
# Эти строки никогда не используются в логике программы, но антивирусы их заметят.
FAKE_TROJAN_SIGNATURES = [
    "e6:2b:4f:3a:9d:1c:7e:8f:0a:11:22:33:44:55:66:77",  # хеш-сигнатура
...
def fake_ransomware_encrypt():
    # Этот код никогда не будет выполнен, но антивирус может его просканировать
...
# Собираем все фальшивые сигнатуры в список (на случай, если антивирус сканирует глобальные переменные)
