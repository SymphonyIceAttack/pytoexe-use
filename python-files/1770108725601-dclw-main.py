...
class InstallerApp(tk.Tk):
    ...
    def _create_widgets(self) -> None:
        ...
        subtitle = tk.Label(
            header,
            text="Промышленный огонь Factorio: установка, моды и контроль обновлений.",
            bg="#15130f",
            fg="#d4b483",
            font=("Segoe UI", 10),
        )
        ...
        self.cancel_btn.grid(row=1, column=1, padx=12, pady=4, sticky="ew")
        ...
        close_btn.grid(row=2, column=0, columnspan=2, padx=12, pady=6, sticky="ew")
    ...
    def _set_operation_state(self, active: bool) -> None:
    ...
    def _cancel_current_operation(self) -> None:
        ...
        self._set_status("Отмена операции...")
    ...
    def _start_subtitle_pulse(self) -> None:
        self.subtitle_palette = ["#d4b483", "#f59e0b", "#f97316", "#d4b483"]
        self.subtitle_index = 0
        self._animate_subtitle()

    def _animate_subtitle(self) -> None:
        if not hasattr(self, "subtitle_label"):
            return
        self.subtitle_label.configure(fg=self.subtitle_palette[self.subtitle_index])
        self.subtitle_index = (self.subtitle_index + 1) % len(self.subtitle_palette)
        self.after(650, self._animate_subtitle)
