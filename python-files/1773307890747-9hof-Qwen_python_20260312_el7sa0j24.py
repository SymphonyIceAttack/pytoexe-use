...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        selection_group = QGroupBox("        selection_layout = QHBoxLayout()
        ...
        self.start_btn = QPushButton(" перевод")
        ...
        # Интервал обновления
        interval        interval_layout.addWidget(QLabel("Интервал (сек):"))
        ...
        # Горячие клавиши
        self.start_shortcut = self.create_shortcut(QKeySequence("Ctrl+R"), self.start_translation)
        self.stop_shortcut = self.create_shortcut(QKeySequence("Ctrl+S"), self.stop_translation)
