...
root.geometry("260x500")  # janela mais estreita
...
def label(text):
    tk.Label(frame, text=text, font=("Arial", 12, "bold")).pack(anchor="w", pady=(8, 0))

def entry(var, readonly=False):
    e = tk.Entry(frame, textvariable=var, font=("Arial", 14))
    if readonly:
