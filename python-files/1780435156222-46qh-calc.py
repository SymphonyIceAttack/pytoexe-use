...
analysetd = float(input("analyse td : "))
...
sum = (mo7asba_sum + i9tisadsum + kanoun_sum + i7timalat_sum + algebr_sum + analyse_sum + english_sum + french_sum + oloumijtima3iya+ info_sum) / 18
print(sum)
