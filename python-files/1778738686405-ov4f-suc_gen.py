        ...
        for idx_sta, sta_name in enumerate(sta_list):
            ...
            for set_no in range(1, n_set+1):
                ...
                for target_name, az_l, az_r, v_l, v_r, dis, zenith_true in set_obs_list:
                    ...
                    line_l = f"{target_name:12s},{az_l_tsy:12.7f},{v_l_tsy:12.7f},{dis:10.5f},   0.0000,      0.0"
                    suc_lines.append(line_l)
                
                az_l_zero_tsy = deg2tsiyuan(az_l_zero)
                v_l_zero_tsy = deg2tsiyuan(v_l_zero)
                line_l_zero = f"{first_target_name:12s},{az_l_zero_tsy:12.7f},{v_l_zero_tsy:12.7f},{first_dis:10.5f},   0.0000,      0.0"
                suc_lines.append(line_l_zero)
                
                az_r_zero_tsy = deg2tsiyuan(az_r_zero)
                v_r_zero_tsy = deg2tsiyuan(v_r_zero)
                line_r_zero = f"{first_target_name:12s},{az_r_zero_tsy:12.7f},{v_r_zero_tsy:12.7f},{first_dis:10.5f},   0.0000,      0.0"
                ...
                for target_name, az_l, az_r, v_l, v_r, dis, zenith_true in reversed(set_obs_list[1:]):
                    ...
                    line_r = f"{target_name:12s},{az_r_tsy:12.7f},{v_r_tsy:12.7f},{dis:10.5f},   0.0000,      0.0"
                ...
                line_r_zero2 = f"{first_target_name:12s},{az_r_zero2_tsy:12.7f},{v_r_zero2_tsy:12.7f},{first_dis:10.5f},   0.0000,      0.0"
