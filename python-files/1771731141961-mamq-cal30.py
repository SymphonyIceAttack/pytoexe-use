...
def toggle_mode():
    ...
    for w in [calc_btn, clear_btn, prev_btn, next_btn, pin_btn, edit_btn, history_btn, view_btn, ai_lamp]:
...
ai_menu_button = ai_menu  # نستخدمها لتغيير حجم الخط مع Scale
