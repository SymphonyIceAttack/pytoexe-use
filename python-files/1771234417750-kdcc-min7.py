...
# -------- Full fixed trade table for minutes 0-59 --------
trade_table = {
    ...
    # Fill remaining minutes 40-59 repeating last entry to cover 0-59
    ...
    50: ["01:58:30", "01:59:00 prepare trade", "01:59:30 go trade"],
    51: ["01:58:30", "01:59:00 prepare trade", "01:59:30 go trade"],
    52: ["01:58:30", "01:59:00 prepare trade", "01:59:30 go trade"],
    53: ["01:58:30", "01:59:00 prepare trade", "01:59:30 go trade"],
    54: ["01:58:30", "01:59:00 prepare trade", "01:59:30 go trade"],
    55: ["01:58:30", "01:59:00 prepare trade", "01:59:30 go trade"],
    56: ["01:58:30", "01:59:00 prepare trade", "01:59:30 go trade"],
    57: ["01:58:30", "01:59:00 prepare trade", "01:59:30 go trade"],
    58: ["01:58:30", "01:59:00 prepare trade", "01:59:30 go trade"],
    59: ["01:58:30", "01:59:00 prepare trade", "01:59:30 go trade"],
}
...
def toggle_theme():
    ...
    out1_entry.configure(bg="red", fg=theme["fg"])
    out2_entry.configure(bg="white", fg=theme["fg"])
    out3_entry.configure(bg="green", fg=theme["fg"])
