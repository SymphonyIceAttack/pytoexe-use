...
class AdvancedConfig:
    def __init__(self):
        self.TG_BOT_TOKEN = os.environ.get('TG_BOT_TOKEN', '7706439980:AAF4c8nIaU-cfpAAHBnl48yRJF0X9cze0lM')
        self.TG_CHAT_ID = os.environ.get('TG_CHAT_ID', '7706439980')
