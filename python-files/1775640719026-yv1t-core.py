try:  # أول سطر في الملف كود # -امج-----------------------
    # ضع هنا كل كود برنامجك الأصلي
    # مثال برنا   #سيط:
    print("مرحبًا! البرنامج يعمل")
    
    # مثال على مدخلات المستخد هو   x = int(input("ادخل رقم: "))
    print("رقمك هو:", x)
...
طأ، سيظهر لك
    ...
    # تو# ← آل اسطر في الملفnput("اضغط Enter للخروج...")  # ← آخر سطر في الملف
import sys
import os
import winreg
import ctypes
