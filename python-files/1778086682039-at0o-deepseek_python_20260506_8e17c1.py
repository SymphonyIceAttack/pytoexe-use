...
# ----------------------------------------------------------------------
# Генерация XML (те же функции, без изменений)
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# Работа с CSV (вместо Excel)
# ----------------------------------------------------------------------
def create_arshin_template_csv(filepath: str):
    """Создаёт CSV-шаблон для Аршин с разделителем ;"""
    headers = [
...
# ----------------------------------------------------------------------
# GUI-класс (почти без изменений, меняются только вызовы шаблонов/загрузки)
# ----------------------------------------------------------------------
class App:
    def __init__(self, root):
        self.root = root
        root.title("Генератор XML для Аршин и Росаккредитации (CSV версия)")
    ...
    # --------------------------------------------------------------
    # Вкладка Аршин (методы аналогичны Excel-версии, но работают с CSV)
    # --------------------------------------------------------------
    ...
    def arshin_generate_xml(self):
        ...
        if not data_rows:
            messagebox.showwarning("Нет данных", "Таблица пуста.")
            return
        try:
