...
def discover_winning_combinations():
    ...
    if len(df) < 10:
        print("Need at least 10 signals for ML analysis")
        return
    ...
    if len(y.unique()) < 2:
        print("Not enough variation in WIN/LOSS data for ML model")
        return
...
def main():
    ...
    if not os.path.exists(MT4_DATA_PATH):
        print("Warning: MT4 path not found:", MT4_DATA_PATH)
