...
def toggle_mode():
    ...
    draw_ai_lamp()  # نعيد رسم اللمبة عند تغيير اللون
...
def draw_ai_lamp():
    ...
    lamp_size = int(BASE_FONT*current_scale*0.3)
    x0, y0 = 2, 2
...
# ================= AI CANVAS LAMP =================
ai_canvas = tk.Canvas(btns, width=10, height=10, bd=0, highlightthickness=0)
