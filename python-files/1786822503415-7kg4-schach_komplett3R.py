...
# ---------- Figuren als Vektorgrafik (SVG-Polygone) ----------
# Jede Figur ist eine kleine Liste einfacher Vektorformen (Polygone, Kreise,
# eine Linie) in einem 0..100-Koordinatenraster - inhaltlich identisch zu den
# <polygon>/<circle>-Elementen der beiliegenden .svg-Dateien. Weiss und
# Schwarz nutzen dieselbe Form, nur mit vertauschten Fuell-/Kontur-Farben.
# Diese Daten werden direkt und ohne jede externe Bibliothek (kein Pillow,
# kein cairosvg) auf das Tkinter-Canvas skaliert - dadurch bleibt das Skript
# bzw. die daraus gebaute .exe so schlank wie moeglich und die Figuren sind
# echte Vektorgrafik: beim Vergroessern/Maximieren des Fensters bleiben die
# Konturen gestochen scharf, statt wie bei Rastergrafiken zu verschwimmen.
PIECE_SHAPES = {
    "P": [
        ("circle", (50, 27, 13)),
        ("poly", [(41, 40), (59, 40), (55, 47), (45, 47)]),
        ("poly", [(38, 90), (62, 90), (57, 47), (43, 47)]),
        ("poly", [(28, 90), (72, 90), (72, 98), (28, 98)]),
    ],
    "R": [
        ("poly", [(24, 90), (76, 90), (76, 98), (24, 98)]),
        ("poly", [(32, 42), (68, 42), (65, 90), (35, 90)]),
        ("poly", [(28, 22), (40, 22), (40, 42), (28, 42)]),
        ("poly", [(44, 22), (56, 22), (56, 42), (44, 42)]),
        ("poly", [(60, 22), (72, 22), (72, 42), (60, 42)]),
        ("poly", [(28, 22), (72, 22), (72, 28), (28, 28)]),
    ],
    "B": [
        ("poly", [(30, 90), (70, 90), (70, 98), (30, 98)]),
        ("poly", [(50, 15), (61, 24), (65, 38), (58, 52),
                  (66, 68), (62, 90), (38, 90), (34, 68),
                  (42, 52), (35, 38), (39, 24)]),
        ("circle", (50, 10, 6)),
        ("line", [(43, 33), (57, 45)]),
    ],
    "N": [
        ("poly", [(24, 90), (76, 90), (76, 98), (24, 98)]),
        ("poly", [
            (66, 90), (66, 65), (60, 58), (66, 50), (58, 42),
            (54, 26), (48, 16), (44, 22), (40, 14), (34, 22),
            (16, 34), (20, 40), (28, 42), (26, 52), (34, 60), (36, 90),
        ]),
        ("circle", (40, 26, 2.6)),
    ],
    "Q": [
        ("poly", [(26, 90), (74, 90), (74, 98), (26, 98)]),
        ("poly", [(34, 82), (66, 82), (61, 50), (39, 50)]),
        ("poly", [(30, 50), (70, 50), (70, 38), (30, 38)]),
        ("poly", [(30, 38), (36, 18), (43, 36), (50, 14),
                  (57, 36), (64, 18), (70, 38)]),
        ("circle", (36, 18, 3.4)), ("circle", (50, 14, 3.4)), ("circle", (64, 18, 3.4)),
    ],
    "K": [
        ("poly", [(26, 90), (74, 90), (74, 98), (26, 98)]),
        ("poly", [(34, 82), (66, 82), (61, 52), (39, 52)]),
        ("poly", [(30, 52), (70, 52), (70, 40), (30, 40)]),
        ("poly", [(47, 10), (53, 10), (53, 30), (47, 30)]),
        ("poly", [(38, 17), (62, 17), (62, 23), (38, 23)]),
    ],
}
...
class ChessApp(tk.Tk):
    ...
    # ---------- Brett zeichnen ----------
    def _draw_piece_vector(self, x0, y0, size, kind, is_white):
        """Zeichnet eine Figur direkt als Vektorgrafik (Polygone/Kreise/Linie
        aus PIECE_SHAPES) in das Feld mit oberer linker Ecke (x0,y0) und
        Kantenlaenge size - ganz ohne Bilddatei, dadurch beliebig scharf
        skalierbar und ohne jede externe Abhaengigkeit."""
        ...
        linienbreite = max(1, round(size * 0.014))

        def punkt(px, py):
            return (x0 + pad + px * scale, y0 + pad + py * scale)

        for befehl, daten in PIECE_SHAPES[kind]:
            if befehl == "poly":
                koords = []
                for px, py in daten:
                    koords.extend(punkt(px, py))
                self.canvas.create_polygon(*koords, fill=fill, outline=outline,
                                            width=linienbreite, joinstyle="round")
            elif befehl == "circle":
                cx0, cy0, r = daten
                cx, cy = punkt(cx0, cy0)
                rr = r * scale
                self.canvas.create_oval(cx - rr, cy - rr, cx + rr, cy + rr,
                                         fill=fill, outline=outline, width=linienbreite)
            elif befehl == "line":
                koords = []
                for px, py in daten:
                    koords.extend(punkt(px, py))
                self.canvas.create_line(*koords, fill=outline,
    ...
    def _redraw_board(self):
        ...
        for r in range(8):
            for c in range(8):
                ...
                piece = board[r][c]
                if piece:
                    self._draw_piece_vector(x0, y0, size, piece.upper(), piece.isupper())
