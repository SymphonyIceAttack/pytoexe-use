...
class CSVSender:
    ...
    def create_widgets(self):
        ...
        # 版本標籤
        version_label = tk.Label(title_container, text="v4.1", 
                                font=("Consolas", 10), 
    ...
    def on_right_click(self, event):
        ...
        if 0 <= data_idx < len(self.rows):
            ...
            for i, cell in enumerate(row):
                ...
                menu.add_command(label=f"複製欄位 {i+1}: {display_text}", 
            ...
            if mode == "筆":
                ...
                if self.auto_col_var.get():
                    ...
                    for i, col in enumerate(row):
                        ...
                        self.log_message(f"✅ 已送出第 {self.index + 1} 筆資料的欄位 {i+1}")
        except Exception as e:
