...
sauth_json_text = json.dumps({
    ...
    "realname": json.dumps({"realname_type": 2}),
    "gameid": "x19",
    "app_channel": "4399com",
    ...
    "sdk_version": "3.12.2",
    "sdkuid": sdk_uid,
    "sessionid": f"{sdk_uid}|0371f9b2b0e764442acec419797dfb6a|44770||74b82bac7fe09a181179eadd820d2818|dcef5b495f74f12baacd40b3cfd14ea4|1781425545|4399",
    "udid": "a10eb03b4b4ba948",
    "client_login_sn": "0156c410468922c9",
    "deviceid": "5c6cb8ce9905c52c"
})
sauth = {"sauth_json": sauth_json_text}
