...
COLOR_FOREGROUND_MAIN_WINDOW = "#046811"
COLOR_LABELS_BORDERS = "#0C7A1B"
COLOR_INPUT_BACKGROUND = '#111111'
COLOR_INPUT_TEXT = "#046D1B"
COLOR_LOG_TEXT = "#095319"
COLOR_BUTTON_BACKGROUND = "#022E11"
COLOR_BUTTON_TEXT = '#FFFFFF'
COLOR_BUTTON_BORDER = "#055813"
COLOR_ERROR_BORDER = "#055512"
COLOR_CREDIT_TEXT = "#055C1F"
...
class PingWindow(QDialog):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('DDOS TOOL – PINGER')
        ...
        layout = QVBoxLayout()
        title = QLabel('DDOS TOOL – PINGER')
        title.setAlignment(Qt.AlignCenter)
        title.setStyleSheet('font-size: 24px; color: #046811; font-weight: bold;')
    ...
    def stop_ping(self):
        if self.worker:
            self.worker.stop()
        self.output.append('\nDDOS TOOL – PINGER FLOOD STOPPED BY USER')
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('DDOS TOOL – by nexza and nebula')
        ...
        self.vantixt_label = QLabel('by Nebula and Nexza')
        ...
        self.mode_selector.addItems(['Silent', 'Medium', 'Extreme', 'Nuclear'])
        ...
        self.start_button = QPushButton('UNLEASH DDOS ATTACK')
    ...
    def load_image_from_url(self, url):
        try:
            ...
            if not pixmap.isNull():
                ...
                self.log_message('DDOS TOOL LOADED. READY FOR DESTRUCTION')
            else:
    ...
    def start_attack(self):
        ...
        self.log_message('UNLEASHING DDOS ATTACKK – by Nebula and Nexza')
    ...
    def stop_attack(self):
        ...
        self.log_message('DDOS TOOL STOPPED. TARGET IS IN RUINS.')
