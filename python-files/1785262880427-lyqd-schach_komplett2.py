...
class ChessApp(tk.Tk):
    ...
    def _show_board_screen(self):
        ...
        tk.Label(right, text="Zugwiedergabe / Verzweigen:", bg=APP_BG, font=("Tahoma", 8, "bold")).pack(pady=(4, 0))
        ...
        tk.Button(ctrl, text="↩ Zug zurücknehmen", bg="#a53a3a", fg="white", bd=0,
                  command=self._nav_back).pack(fill="x", pady=2)
        tk.Button(ctrl, text="↪ Zug wiederherstellen", bg="#3a7aa5", fg="white", bd=0,
                  command=self._nav_forward).pack(fill="x", pady=2)
