...
class App:
    ...
    def init_arshin_tab(self):
        ...
        # Добавляем примеры данных (пригодный и непригодный приборы)
        example_row = [
            "47957-11", "3026171", "2013", "ТОП-0,66 У3", "ГЗО",
            "Восточное производственное отделение", "18.07.2025", "17.07.2030",
            "пригодно", "", "ГОСТ 8.217-2024", "Наседкин Дмитрий Александрович",
    ...
    def arshin_add_row(self, data=None):
        """Добавляет строку. Если data передан, использует его, иначе — пустую строку."""
        if data is None:
    ...
    def init_accreditation_tab(self):
        ...
        # Добавляем примеры данных (пригодный и непригодный)
        example_row = [
    ...
    def accred_add_row(self, data=None):
        """Добавляет строку в таблицу аккредитации."""
        if data is None:
