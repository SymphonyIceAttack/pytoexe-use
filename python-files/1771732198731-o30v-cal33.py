...
def toggle_mode():
    ...
    draw_ai_lamp()  # إعادة رسم اللمبة بعد التغيير
...
def apply_scale(val):
    ...
    draw_ai_lamp()  # تحديث حجم اللمبة مع السكيل
...
def draw_ai_lamp():
    ...
    lamp_size = int(BASE_FONT*current_scale*0.3*1.3)  # زيادة 30% والتفاعل مع السكيل
    x0, y0 = 2, 2
...
ai_menu_button = ai_menu  # لضبط حجم الخط مع Scale
