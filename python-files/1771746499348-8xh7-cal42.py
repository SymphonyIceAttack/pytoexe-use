...
def calculate(event=None):
    ...
    if ai_mode and v in AI_SPECIALS:
        # الرقم صغير، العلامة أكبر، next تحتها
        middle_text = f"{v} <\nnext"
        middle_font = (current_font, int(BASE_FONT*current_scale*1.5))
...
middle_lbl = tk.Label(res,width=6,bg="white")  # width زيادة لتتناسب مع الرقم والعلامة
