...
class AccountHelper:
    def __init__(self, root):
        ...
        self.fab_color = "#FF9A9E"
        self.card_color = "#FFFFFF"
        self.text_color = "#57606F"
        self.btn_user = "#74B9FF"
        self.btn_pass = "#FF6B81"
    ...
    def get_accounts_file(self):
        """返回 accounts.txt 的完整路径"""
        return os.path.join(self.get_base_path(), "accounts.txt")
    # ================================================
    ...
    def load_accounts(self):
        self.accounts = []
        file_path = self.get_accounts_file()
        
        # 调试用：如果找不到文件，弹窗显示它在哪找的
        # tk.messagebox.showinfo("路径", f"正在查找: {file_path}")
        ...
        if os.path.exists(file_path):
            ...
            try:
                with open(file_path, "w", encoding="utf-8") as f:
                    f.write("百度,myname@baidu.com,123456\n")
                    f.write("淘宝,buyer001,abc@123\n")
                    f.write("QQ,123456789,myqqpass\n")
