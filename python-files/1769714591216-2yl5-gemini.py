...
def edit_code_with_versions():
    ...
    tk.Button(bottom_frame, text="Apply & Save Code", command=save_changes,
              bg="green", fg="white", font=("Arial", 14, "bold"), padx=10, pady=5).pack(side="left", padx=5)
    ...
    tk.Button(bottom_frame, text="Load Selected Version", command=load_selected_version,
              bg="blue", fg="white", font=("Arial", 12, "bold")).pack(side="left", padx=5)
    ...
    tk.Button(bottom_frame, text="Restore Last Good Version", command=restore_last_good,
