...
def main():
    while True:
        ...
        if choice == "1":
            ...
            target_max_hp = 150.0 if "X-24" in armor_choice else 100.0
            ...
            if armor_hp > 0:
                if is_melee:
                    ...
                    initial_armor_dmg = base_dmg * safe_float_convert(armor_stats.get("Blast Resistance", 0)) if a_key else 0
                    if hit_loc == "body":
