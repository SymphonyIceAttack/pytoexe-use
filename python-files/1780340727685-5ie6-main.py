...
class TypingTestApp:
    ...
    def set_custom_text(self):
        ...
        dialog_window.transient(self.root) # Делает диалог модальным к главному окну
    ...
    def save_and_close(self, text_widget, window):
        """
        Сохраняет введенный текст в переменную self.custom_phrase
        и закрывает окно.
        """
    ...
    def highlight_errors(self):
        ...
        Исправлена логика обработки строк разной длины.
        """
        user_text = self.entry_input.get()
