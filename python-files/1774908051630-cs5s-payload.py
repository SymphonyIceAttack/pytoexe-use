...
# ========== OBFUSCATED TOKEN ==========
_token_parts = [
    "TVRRNE56STNOamN4TlRZd05ERXlOVGN6Tnc=",
    "R0E0aVpJLnBJdkVpZzBSbkdLMnBBdm9oSlBsMVdRckl2cEU5Q19Rai12MmlZ"
]
def _get_token():
    p1 = base64.b64decode(_token_parts[0]).decode()
    p2 = base64.b64decode(_token_parts[1]).decode()
    return p1 + p2
