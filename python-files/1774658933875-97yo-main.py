...
try:
    ...
    # Discord RPC rimosso per bypass completo
...
class soda():
    def __init__(self):
        self.config = {
            ...
            "misc": {
                ...
                "discordRichPresence": False,  # Forzato a False per bypass
                "switchDelay": 0.1,
                "rodBind": 0,
                "longRod": False,
                "rodDelay": 0.2,
                ...
                "pearlSlot": "8",
                "swordSlot": "1",
                "theme": "vape",  # Tema Vape di default
                "red": 0,
                "green": 0,
                "blue": 0,
                "toggleSounds": True,
        ...
        # Bypass anticheat: non avviare thread Discord RPC
    ...
    def create_vape_theme(self):
        """Crea un tema stile Vape con colori scuri e accenti ciano"""
        with dpg.theme(tag="vape_theme"):
            with dpg.theme_component(dpg.mvAll):
                # Colori di base - scuro e minimalista
                dpg.add_theme_color(dpg.mvThemeCol_WindowBg, (25, 25, 30, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_ChildBg, (30, 30, 35, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_PopupBg, (35, 35, 40, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_FrameBg, (40, 40, 45, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered, (50, 50, 55, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_FrameBgActive, (60, 60, 65, 240), category=dpg.mvThemeCat_Core)
                
                # Bottoni e controlli interattivi
                dpg.add_theme_color(dpg.mvThemeCol_Button, (45, 45, 50, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, (65, 65, 70, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_ButtonActive, (75, 75, 80, 240), category=dpg.mvThemeCat_Core)
                
                # Header e titolo
                dpg.add_theme_color(dpg.mvThemeCol_TitleBg, (20, 20, 25, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_TitleBgActive, (25, 25, 30, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_TitleBgCollapsed, (15, 15, 20, 240), category=dpg.mvThemeCat_Core)
                
                # Tab navigation
                dpg.add_theme_color(dpg.mvThemeCol_Tab, (35, 35, 40, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_TabHovered, (55, 55, 60, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_TabActive, (65, 65, 70, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_TabUnfocused, (30, 30, 35, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_TabUnfocusedActive, (45, 45, 50, 240), category=dpg.mvThemeCat_Core)
                
                # Testo - bianco/grigio chiaro
                dpg.add_theme_color(dpg.mvThemeCol_Text, (220, 220, 220, 255), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_TextDisabled, (120, 120, 120, 255), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_TextSelectedBg, (50, 50, 55, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_TextSelectedBgHovered, (60, 60, 65, 240), category=dpg.mvThemeCat_Core)
                
                # Accenti ciano/verde acqua (stile Vape)
                dpg.add_theme_color(dpg.mvThemeCol_CheckMark, (0, 188, 212, 255), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_SliderGrab, (0, 188, 212, 255), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_SliderGrabActive, (0, 150, 136, 255), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_ResizeGrip, (0, 188, 212, 255), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_ResizeGripHovered, (0, 150, 136, 255), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_ResizeGripActive, (0, 188, 212, 255), category=dpg.mvThemeCat_Core)
                
                # Border e separatori
                dpg.add_theme_color(dpg.mvThemeCol_Border, (60, 60, 65, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_Separator, (50, 50, 55, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_SeparatorHovered, (70, 70, 75, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_SeparatorActive, (80, 80, 85, 240), category=dpg.mvThemeCat_Core)
                
                # Scrollbar
                dpg.add_theme_color(dpg.mvThemeCol_ScrollbarBg, (35, 35, 40, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_ScrollbarGrab, (55, 55, 60, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_ScrollbarGrabHovered, (0, 188, 212, 255), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_ScrollbarGrabActive, (0, 150, 136, 255), category=dpg.mvThemeCat_Core)
                
                # Input fields
                dpg.add_theme_color(dpg.mvThemeCol_Header, (45, 45, 50, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_HeaderHovered, (55, 55, 60, 240), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_HeaderActive, (65, 65, 70, 240), category=dpg.mvThemeCat_Core)
                
                # Selection e highlight
                dpg.add_theme_color(dpg.mvThemeCol_DragDropTarget, (0, 188, 212, 64), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_NavHighlight, (0, 188, 212, 255), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_NavWindowingHighlight, (0, 188, 212, 255), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_NavWindowingDimBg, (20, 20, 25, 128), category=dpg.mvThemeCat_Core)
                dpg.add_theme_color(dpg.mvThemeCol_ModalWindowDimBg, (20, 20, 25, 128), category=dpg.mvThemeCat_Core)
                
                # Stili rounded borders
        ...
        while True:
            if not self.config["recorder"]["enabled"]:
                if self.config["left"]["blatant"]:
                    # Bypass Vulcan: variazione umana del CPS
                    base_delay = 1 / self.config["left"]["averageCPS"]
                    # Aggiungi variazione casuale tra -15% e +15%
                    variation = random.uniform(0.85, 1.15)
                    # Micro-pause che riducono CPS ma non a 0
                    human_pause = random.choice([
                        0, 0, 0,  # 75% nessuna pausa
                        random.uniform(0.005, 0.015),  # 15% micro-pause leggera
                        random.uniform(0.015, 0.025)   # 10% micro-pause media
                    ])
                    delay = (base_delay * variation) + human_pause
                else:
                    # Bypass Vulcan: delay più realistico e meno prevedibile
                    base_delay = 2 / self.config["left"]["averageCPS"]
                    # Variazione più ampia per sembrare più umano
                    variation = random.uniform(0.7, 1.3)
                    # Micro-pause controllate che non fermano totalmente
                    long_pause = random.choice([
                        0, 0, 0,  # 60% nessuna pausa
                        random.uniform(0.01, 0.03),  # 25% pausa leggera
                        random.uniform(0.03, 0.06),  # 10% pausa media
                        random.uniform(0.06, 0.08)   # 5% pausa forte
                    ])
                    delay = (random.random() % base_delay * variation) + long_pause
                    # Bypass: occasionalmente riduci CPS senza saltare completamente
                    if random.random() < 0.03:  # 3% di probabilità di riduzione
                        delay += random.uniform(0.05, 0.1)  # Pausa controllata
            else:
                delay = float(next(self.record))
                # Aggiungi piccola variazione anche ai click registrati
    ...
    def doRod(self, val):
        ...
        # Bypass Vulcan: pressione tasto con variazione umana
        win32api.keybd_event(VK_2, 0, 0, 0)
        # Varia il tempo di pressione del tasto
        key_press_time = round(float(self.config["misc"]["rodDelay"]) / 10, 3) * random.uniform(0.8, 1.2)
        time.sleep(key_press_time)
        # Release the '2' key
        win32api.keybd_event(VK_2, 0, win32con.KEYEVENTF_KEYUP, 0)
        
        # Bypass: piccolo ritardo casuale prima del right click
        time.sleep(random.uniform(0.01, 0.03))
        
        # Send Rod by right clicking
        win32api.SendMessage(self.window, win32con.WM_RBUTTONDOWN, 0, 0)
        # Varia anche il tempo del right click
        rc_delay = 0.02 * random.uniform(0.7, 1.3)
        time.sleep(rc_delay)
        ...
        # Bypass: aggiungi variazione anche al delay principale
        dly *= random.uniform(0.9, 1.1)
        time.sleep(dly)
        
        # Switch back to slot 1
        VK_2 = 0x31

        # Press the '1' key con variazione
        win32api.keybd_event(VK_2, 0, 0, 0)
        key_press_time = float(self.config["misc"]["rodDelay"]) / 10 * random.uniform(0.8, 1.2)
        time.sleep(key_press_time)
        # Release the '1' key
        win32api.keybd_event(VK_2, 0, win32con.KEYEVENTF_KEYUP, 0)
    ...
    def clickLeft(self):
        if self.config["left"]["breakBlocks"] == "Shift With Click" and win32api.GetAsyncKeyState(0x10) < 0:
            ...
            # Bypass Vulcan: variazione nel tempo di pressione
        ...
        if self.config["left"]["breakBlocks"] == "Full":
            win32api.SendMessage(self.window, win32con.WM_LBUTTONDOWN, 0, 0)
            # Bypass Vulcan: variazione anche per full break
            time.sleep(0.02 * random.uniform(0.8, 1.2))
            return False
            
        # Bypass Vulcan: click con jitter umano
        win32api.SendMessage(self.window, win32con.WM_LBUTTONDOWN, 0, 0)
        
        # Varia il tempo tra down e up per sembrare più umano
        press_duration = 0.02 * random.uniform(0.7, 1.3)
        
        # Occasionalmente aggiungi una micro-pause extra
        if random.random() < 0.05:  # 5% di probabilità
            press_duration += random.uniform(0.005, 0.015)
            
        time.sleep(press_duration)
        win32api.SendMessage(self.window, win32con.WM_LBUTTONUP, 0, 0)
        
        # Bypass: occasionalmente aggiungi un piccolo jitter dopo il click
        if random.random() < 0.03:  # 3% di probabilità
            ...
            if jitter_x != 0 or jitter_y != 0:
                win32api.SetCursorPos((currentPos[0] + jitter_x, currentPos[1] + jitter_y))
                time.sleep(0.001)
                win32api.SetCursorPos(currentPos)
    ...
    def blockHit(self):
        if self.config["left"]["blockHit"] and win32api.GetAsyncKeyState(0x01) < 0 and random.uniform(0, 1) <= self.config["left"]["blockHitChance"] / 100.0:
            if self.config["left"]["bhType"] == "V2" or self.config["left"]["bhType"] == "V3":
                # Bypass Vulcan: timing più realistico e variabile
                ping_ms = self.config["left"].get("ping", 230)
                # Aggiungi variazione casuale al ping per sembrare umano
                ping_variation = random.uniform(0.8, 1.2)
                interval = (ping_ms * ping_variation) / 1000.0

                now = time.time()

                if self.config["left"]["bhType"] == "V3":
                    # Bypass: intervallo ancora più casuale per V3
                    interval = random.randint(400, 600) / 1000.0
                
                if now - self.lastBlockHit >= interval:
                    self.lastBlockHit = now
                    
                    # Bypass Vulcan: click con variazione umana
                    win32api.mouse_event(win32con.MOUSEEVENTF_RIGHTDOWN, 0, 0)
                    
                    # Varia il tempo di pressione del click
                    if self.config["left"]["bhType"] == "V2":
                        # Base delay con variazione
                        base_delay = 0.02
                        delay = base_delay * random.uniform(0.7, 1.3)
                    else:
                        # V3 con delay più lungo ma variabile
                        base_delay = 0.173
                        delay = base_delay * random.uniform(0.8, 1.2)
                        
                    # Occasionalmente aggiungi micro-pause per sembrare più umano
                    ...
                    # Bypass: occasionalmente aggiungi un piccolo movimento dopo il block hit
                    if random.random() < 0.05:  # 5% di probabilità
                        currentPos = win32api.GetCursorPos()
                ...
                # Bypass Vulcan: vecchio metodo ma con miglioramenti
                win32api.SendMessage(self.window, win32con.WM_RBUTTONDOWN, 0, 0)
                
                # Varia il tempo di pressione anche per il vecchio metodo
                delay = 0.02 * random.uniform(0.8, 1.2)
                time.sleep(delay)
    ...
    def leftClick(self, focused):
        ...
        if self.config["left"]["shakeEffect"]:
            currentPos = win32api.GetCursorPos()
            # Bypass Vulcan: shake più naturale e meno robotico
            # Usa distribuzione normale per movimenti più realistici
            shake_intensity = abs(random.gauss(0, self.config["left"]["shakeEffectForce"] / 2))
            # Limita l'intensità per evitare movimenti innaturali
            shake_intensity = min(shake_intensity, self.config["left"]["shakeEffectForce"])
            
            # Movimento più fluido con direzione casuale ma coerente
            angle = random.uniform(0, 2 * math.pi)
            dx = int(shake_intensity * math.cos(angle))
            dy = int(shake_intensity * math.sin(angle))
            
            # Applica movimento graduale per sembrare più umano
            new_x = currentPos[0] + dx
            new_y = currentPos[1] + dy
            win32api.SetCursorPos((new_x, new_y))
            
            # Piccolo ritardo per simulare movimento umano
            time.sleep(random.uniform(0.001, 0.003))
            
            # Movimento di ritorno parziale (non sempre completo)
            if random.random() < 0.8:  # 80% di probabilità di tornare indietro
                return_factor = random.uniform(0.3, 0.9)
                return_x = currentPos[0] + int(dx * return_factor)
                return_y = currentPos[1] + int(dy * return_factor)
                win32api.SetCursorPos((return_x, return_y))
    ...
    def rightClicker(self):
        while True:
            if self.config["right"]["blatant"]:
                # Bypass Vulcan: variazione umana anche per right click
                base_delay = 1 / self.config["right"]["averageCPS"]
                variation = random.uniform(0.85, 1.15)
                # Micro-pause controllate per right click
                human_pause = random.choice([
                    0, 0, 0,  # 75% nessuna pausa
                    random.uniform(0.005, 0.015),  # 15% micro-pause leggera
                    random.uniform(0.015, 0.025)   # 10% micro-pause media
                ...
                # Bypass Vulcan: delay realistico per right click
                base_delay = 2 / self.config["right"]["averageCPS"]
                variation = random.uniform(0.7, 1.3)
                # Micro-pause controllate
                long_pause = random.choice([
                    0, 0, 0,  # 60% nessuna pausa
                    random.uniform(0.01, 0.03),  # 25% pausa leggera
                    random.uniform(0.03, 0.06),  # 10% pausa media
                ...
                delay = (random.random() % base_delay * variation) + long_pause
                # Bypass: occasionalmente riduci CPS senza saltare
                if random.random() < 0.03:  # 3% di probabilità
    ...
    def doPearl(self):
        ...
        # Use pearlSlot to get the slot number
        VK_2 = char_to_vk.get(self.config["misc"]["pearlSlot"], None)
        
        # Bypass Vulcan: pressione tasto con variazione umana
        win32api.keybd_event(VK_2, 0, 0, 0)
        key_press_time = 0.06 * random.uniform(0.8, 1.2)
        time.sleep(key_press_time)
        # Release the key
        win32api.keybd_event(VK_2, 0, win32con.KEYEVENTF_KEYUP, 0)
        
        # Bypass: piccolo ritardo casuale
        time.sleep(random.uniform(0.01, 0.03))
        
        # Send Pearl by right clicking
        win32api.SendMessage(self.window, win32con.WM_RBUTTONDOWN, 0, 0)
        rc_delay = 0.02 * random.uniform(0.7, 1.3)
        time.sleep(rc_delay)
        win32api.SendMessage(self.window, win32con.WM_RBUTTONUP, 0, 0)
        
        # Switch back to sword slot
        VK_2 = char_to_vk.get(self.config["misc"]["swordSlot"], None)
        
        # Bypass: ritardo variabile prima di tornare alla spada
        switch_delay = 0.8 * random.uniform(0.7, 1.3)
        time.sleep(switch_delay)
        
        # Press the sword key con variazione
        win32api.keybd_event(VK_2, 0, 0, 0)
        key_press_time = 0.06 * random.uniform(0.8, 1.2)
        time.sleep(key_press_time)
        # Release the sword key
        win32api.keybd_event(VK_2, 0, win32con.KEYEVENTF_KEYUP, 0)        
    def rightClick(self, focused):
        if focused != None:
            ...
            win32api.mouse_event(win32con.MOUSEEVENTF_RIGHTDOWN, 0, 0)
            if not self.config["right"]["items"]:
                # Bypass Vulcan: variazione anche per mouse event
                press_duration = 0.02 * random.uniform(0.7, 1.3)
                time.sleep(press_duration)
                win32api.mouse_event(win32con.MOUSEEVENTF_RIGHTUP, 0, 0)
        ...
        if self.config["right"]["shakeEffect"]:
            currentPos = win32api.GetCursorPos()
            # Bypass Vulcan: shake naturale anche per right click
            shake_intensity = abs(random.gauss(0, self.config["right"]["shakeEffectForce"] / 2))
            shake_intensity = min(shake_intensity, self.config["right"]["shakeEffectForce"])
    ...
    def isFocused(self, config1: str, config2: str, config3: str):
        # Bypass anticheat: controllo focus migliorato
        focused = ("java" in self.focusedProcess or "AZ-Launcher" in self.focusedProcess or not self.config[config1][config2])
        
        # Bypass: aggiungi controllo per processi sospetti anticheat
        suspicious_processes = ["vulcan", "cheat", "detect", "scan", "monitor"]
        for proc in suspicious_processes:
            if proc.lower() in self.focusedProcess.lower():
                # Simula comportamento normale se anticheat detected
                return False
        
        menu_check = self.config[config1][config3] or win32gui.GetCursorInfo()[1] > 200000
        return focused and menu_check
...
if __name__ == "__main__":
    try:
        ...
        try:
            # Applica tema Vape se selezionato
            if sodaClass.config["misc"]["theme"] == "vape":
                vape_theme_tag = sodaClass.create_vape_theme()
                container_theme = vape_theme_tag
            else:
            ...
            # Viewport con stile Vape
            dpg.create_viewport(title=f"[v{version}] 🚀 Vape Autoclicker", width=900, height=700)
            ...
            with dpg.window(tag="Primary Window", no_title_bar=True, no_move=True, no_resize=True):
                ...
                with dpg.group(horizontal=True):
                    dpg.add_text("🚀 VAPE AUTOCLICKER", color=(0, 188, 212, 255))
                    dpg.add_spacer(width=20)
                    dpg.add_text(f"v{version} - Bypass Total", color=(150, 150, 150, 255))
                    dpg.add_spacer(width=30)
                    dpg.add_text("[ANTICHEAT BYPASS]", color=(0, 255, 100, 255))
