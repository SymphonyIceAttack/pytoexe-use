...
class TypingTestApp:
    def __init__(self, root):
        ...
        self.root.geometry("900x650") # Увеличено окно
        ...
        self.text_display.tag_configure('error', background='#FFB3BA')   # Светло-красный
    ...
    def start_test(self):
        ...
        # Удаляем все теги перед новым тестом
