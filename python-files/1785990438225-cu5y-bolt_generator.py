...
def calc_z_positions(bolt_size, bolt_length, t_input):
    ...
    v7/v8/v9 algorithm (unchanged in v10):
...
# ============================================================
# GUI Application (Chinese UI - v7/v8/v9 style, unchanged)
# ============================================================
