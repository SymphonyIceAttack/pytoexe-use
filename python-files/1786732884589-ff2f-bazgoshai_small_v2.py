...
class App:
    ...
    def build_ui(self):
        ...
        self.sym1 = ttk.Entry(sym_frame, width=24, justify="center")
        ...
        self.sym2 = ttk.Entry(sym_frame, width=24, justify="center")
        self.sym2.grid(row=0, column=3, padx=8, pady=8)
    ...
    def register_f2_hotkey(self):
        # Global F2 hotkey on Windows.
        user32.RegisterHotKey(None, HOTKEY_ID, MOD_NOREPEAT, VK_F2)
    ...
    def read_settings(self):
        ...
        if self.click_x is None:
            raise ValueError("ابتدا مختصات کلیک را با F2 ثبت کنید.")
    ...
    def start(self):
        ...
        self.main_status.set("● در حال پیدا کردن نمادها...")
        self.running = True
    ...
    def resolve_and_start(self, names):
        ...
        try:
            ...
            self.root.after(0, lambda: self.start_failed(str(exc)))
