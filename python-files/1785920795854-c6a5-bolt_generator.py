# -*- coding: utf-8 -*-
"""
Fastener Assembly TXT Generator v8
Generates Bocad-format fastener assembly input files based on
bolt size, connection thickness, and bolt length.

v8: Geometry reverts to v4 baseline (verified by Bocad rendering),
    algorithm and UI from v7.
...
# ============================================================
# Reference Vertex Patterns (M20 base) - v4 baseline, DO NOT ALTER
...
def fmt_thickness(val):
    """Format thickness value for filename (v7 convention)."""
    if val == int(val):
        return f"{int(val)}"
    else:
        s = f"{val:.2f}".rstrip('0').rstrip('.')
...
# ============================================================
# Z Position Calculations (v7 algorithm + v4 single-cylinder bolt)
# ============================================================
...
def calc_z_positions(bolt_size, bolt_length, t_input):
    ...
    v8: single CYLINDER bolt blank (v4 geometry) + v7 algorithm
...
# ============================================================
# TXT File Generation - Bocad format (v4 geometry + v7 algorithm)
# ============================================================

def generate_fastener_txt(bolt_size, bolt_length, t_input):
    """
    Generate fastener assembly TXT file in Bocad format.
    Geometry matches v4 baseline (m20x130-95.5.txt) exactly.
    Algorithm matches v7 (T_input = connector thickness).
    ...
    # Scale vertices (v4 baseline patterns, DO NOT change vertex logic)
...
# ============================================================
# GUI Application (Chinese UI - v7 style)
# ============================================================
...
class BoltGeneratorApp:
    ...
    def generate_fastener(self):
        ...
        # Default filename (v7 convention: M{size}x{length}-{thickness}.txt)
