...
class WaterElectricityCalcSimple:
    ...
    def init_ui(self):
        ...
        self.cb_building = ttk.Combobox(input_frame, textvariable=self.building_var,
                                        values=buildings, state="readonly", width=20)
        self.cb_building.current(0)
        self.cb_building.grid(row=0, column=1, sticky=tk.W, pady=5, padx=(10, 0))
