...
# RabbitFX CN Mod Fixer - by Caverabbot assisted and supervised by Caverabbit
...
def fix_ini(path):
	...
	for line in lines:
		...
		# Only consider lines that start with "if" (after stripping)
		if stripped.startswith("if"):
			# Match any form containing vs == 200
			if "vs == 200" in stripped:
				new_lines.append(indent + "if vs == 1718.2 || vs == 1718.3\n")
				continue

			# Match any form containing vs == 202
			if "vs == 202" in stripped:
