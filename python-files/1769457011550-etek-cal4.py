...
def calculate(event=None):
    ...
    # Middle special handling
    if value in SPECIAL_MIDDLES:
        middle_lbl.config(text=str(value), bg=COLOR_SPECIAL)
    else:
        middle_lbl.config(text=str(middle), bg=COLOR_MIDDLE)
