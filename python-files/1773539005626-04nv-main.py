...
def fix_ar(text):
    """
    Proper RTL fix for tkinter:
    - Pure Arabic  -> reverse word order
    - Mixed Arabic+English -> reverse word order, English tokens stay readable
    - Pure English -> unchanged
    Uses bidi-style approach: reverse words, keep quoted/bracketed tokens intact
    """
    if not text:
        return text
