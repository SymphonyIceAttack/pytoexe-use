...
class TramwayClimateSimulator:
    def __init__(self, root):
        self.root = root
        self.root.title("Climat-Manager BUILD_02.03.2026")
    ...
    def simulate_tramway(self):
        ...
        while self.running:
            ...
            if self.auto_mode:
                self.update_control_from_sensors()
    ...
    def update_control_from_sensors(self):
        """Управление на основе показаний датчиков"""
    ...
    def draw_temp_graph(self):
        ...
        # Цветовые зоны комфорта
        zones = [
            (18, 20, '#3a4a8a'),  # Холодно
            (20, 22, '#3a8a3a'),  # Комфортно
            (22, 24, '#3a8a3a'),  # Комфортно
            (24, 26, '#8a8a3a'),  # Тепло
            (26, 35, '#8a3a3a')   # Жарко
        ]
    ...
    def draw_co2_graph(self):
        ...
        # Цветовые зоны CO2
        zones = [
            (350, 600, '#1a3a1a'),  # Отличный
            (600, 800, '#2a4a2a'),  # Хороший
            (800, 1000, '#3a3a1a'), # Средний
    ...
    def update_ui(self):
        ...
        # Цвет CO2
        if self.current_co2 < 600:
            self.co2_label.config(fg='#a0ffa0')
        elif self.current_co2 < 800:
            self.co2_label.config(fg='#a0ffa0')
