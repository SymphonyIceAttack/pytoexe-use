    ...
    def gerar_kmz(self):
        ...
        try:
            ...
            for i, ponto in enumerate(self.pontos_finais, 1):
                ...
                p = kml.newpoint()
                p.name = ponto['nome']
                # CORRIGIDO: usar aspas duplas para o HTML e aspas simples para o Python
                p.description = '<img src="imagens/' + ponto['nome'] + '" width="400"/><br/><b>Coordenada:</b> ' + f"{ponto['lat']:.6f}" + ', ' + f"{ponto['lon']:.6f}"
